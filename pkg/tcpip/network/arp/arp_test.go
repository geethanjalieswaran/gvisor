...
func newTestContext(t *testing.T) *testContext {
	...
	d := arpDispatcher{
		...
		// while dispatching events. Blocking could potentially mess with the
		// timing of NUD transitions. The size choosen here of 32 will be
		// sufficient to queue all the events we are receiving in these tests
		// before consumption with expectEvents().
